        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              Its another one of surreal works and in the world of competing
              against every other individual, the smaller insects climb the
              ladder to become bigger insects with a higher appetite.
            </p>
            <p>
