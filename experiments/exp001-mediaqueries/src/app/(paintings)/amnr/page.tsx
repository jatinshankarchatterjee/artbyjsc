        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              A surrealist painting depicting the extravagance and adapted
              finesse of a rose. In a simpler way of explaining, how a person
              changes once the surroundings change, however the core is just as
              raw as it was at he beginning.
            </p>
            <p>
            ...
            <p>
              ...
              Probably signed on the back with no blank margins at all.
            </p>
          </div>
        </div>
      </div>
