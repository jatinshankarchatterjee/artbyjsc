        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              As the title suggests, the Queen had been running down everyone
              else contributing to the constitution of commonwealth more or less
              as a pauper which resulted in the overturning of the throne.
            </p>
            <p>
