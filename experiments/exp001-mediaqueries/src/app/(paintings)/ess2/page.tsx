...
export default function Essentials2() {
  return (
    <>
        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              This is the second of a three painting series titled essentials
              and were painted during the Covid hoax or drama at a global
              government level. This one is dedicated to grains, oils, pulses
              etc. and it all is a commercial play for an online increase of
              things.
            </p>
            <p>
            ...
            <p>
              ...
              signed at the back and has no blank margins left at all.
            </p>
          </div>
        </div>
      </div>
