...
export default function Broses() {
  return (
    <>
        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              The painting is geometrical approach and displays a vase of roses
              that are sharper than the thorns they possess. One of my favourite
              creations and the vase is created like a yellow topaz symbolizing
              wealth of the beholder.
            </p>
            <p>
