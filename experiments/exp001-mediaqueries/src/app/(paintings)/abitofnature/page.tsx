...
export default function Abitofnature() {
  return (
    <>
        ...
        <div className="flex-row border-2 border-black dark:border-white w-1/2 portrait:w-[80%] my-4">
          ...
          <div className="flex-row space-y-2 mx-4">
            ...
            <p>
              ...
              A painting of a lake and mountains. influenced by impressionist
              techniques, with little, loose brush strokes.
            </p>
            <p>
            ...
            <p>
              ...
              Signed at front right bottom and has no blank margins at all.
            </p>
          </div>
        </div>
      </div>
